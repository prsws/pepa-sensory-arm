"""Config flow for Pepa Sensory Arm integration.

This module implements the configuration UI for the Pepa Sensory Arm custom component,
...
class PepaSensoryArmConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):  # type: ignore[call-arg]
    """Handle a config flow for Pepa Sensory Arm.

    This config flow implements multi-step configuration for the Pepa Sensory Arm
    ...
    def async_get_options_flow(
        ...
        Returns:
            PepaSensoryArmOptionsFlow instance
        """
        return PepaSensoryArmOptionsFlow(config_entry)


class PepaSensoryArmOptionsFlow(config_entries.OptionsFlow):
    """Handle options flow for Pepa Sensory Arm.
    ...
    async def async_step_llm_settings(
        ...
        if user_input is not None:
            ...
            try:
                ...
                temp_flow = PepaSensoryArmConfigFlow()
