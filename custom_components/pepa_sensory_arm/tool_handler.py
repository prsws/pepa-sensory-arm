"""Tool handler for managing and executing tools in the Pepa Sensory Arm component.
...
class ToolHandler:
    """Handles tool registration, validation, and execution for Pepa Sensory Arm.
