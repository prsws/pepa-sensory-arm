"""Streaming functionality mixin for PepaSensoryArm.
...
Architecture:
    StreamingMixin is designed as a mixin class to be inherited by PepaSensoryArm. It
...
Error Handling:
    ...
    - PepaSensoryArmError: Raised on API errors or connection failures
